...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'app_recipe', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(default='media/photos/reeses.jpg', max_length=254),
                      keep_default=False)
    ...
    models = {
        ...
        u'app.recipe': {
            ...
            'photo': ('django.db.models.fields.files.ImageField', [], {'default': "'media/photos/reeses.jpg'", 'max_length': '254'}),
