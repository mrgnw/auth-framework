...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Photo'
        db.create_table(u'app_photo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'app', ['Photo'])

        # Adding field 'Recipe.photo'
        db.add_column(u'app_recipe', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(default='photos/reese.jpg', max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'app_photo')

        # Deleting field 'Recipe.photo'
        db.delete_column(u'app_recipe', 'photo')
    ...
    models = {
        ...
        u'app.recipe': {
            ...
            'photo': ('django.db.models.fields.files.ImageField', [], {'default': "'photos/reese.jpg'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
