...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recipe.photo'
        db.alter_column(u'app_recipe', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=254, null=True))

    def backwards(self, orm):

        # Changing field 'Recipe.photo'
        db.alter_column(u'app_recipe', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=254))
    ...
    models = {
        ...
        u'app.recipe': {
            ...
            'photo': ('django.db.models.fields.files.ImageField', [], {'default': "'media/photos/reeses.jpg'", 'max_length': '254', 'null': 'True', 'blank': 'True'}),
